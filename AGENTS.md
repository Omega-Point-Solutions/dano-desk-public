...
DAN-O: sovereign RAG AI engine for public-safety and investigations. Runs on-prem/edge, no third-party model calls. By O
...
- Flag any credential, internal hostname, or private endpoint committed to this
  repository.
- Input from outside the process is validated before use.
